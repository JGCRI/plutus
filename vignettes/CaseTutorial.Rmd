...
<a name="table1"></a>
**Table 1:** Data and assumption files. ~\\ represent the path to your GCAM v5.3 home folder.
...
- `data`: a dataframe with the post-processed GCAM output showing stranded assets and electricity investments (see [Table 1](#table1)) by scenario, region, technology, and time period 
...
`data` contains the the most detailed information. Check the structure and content of `data` and select the most relevant columns including scenario, region, param, class1 (= fuel types), x (= year), units, and value.
